...
namespace Mpts.Library.Controls
{
  ...
  public class AdvancedFolderBrowserDialog:IDisposable
  {
    ...
    /// 
    /// </summary>
    public AdvancedFolderBrowserDialog()
    {
  ...
  //public partial class AdvancedFolderBrowserDialog: Component
  //{
  //  public AdvancedFolderBrowserDialog()
  //  {
  //    InitializeComponent();
  //    this.Disposed += new EventHandler( AdvancedFolderBrowserDialog_Disposed );
  //    //this.myFolderBrowserDialog.Container.Add( new TextBox() );
  //  }
  //  public DialogResult ShowDialog()
  //  {
  //    return myFolderBrowserDialog.ShowDialog();
  //  }
  ...
  //  void AdvancedFolderBrowserDialog_Disposed( object sender, EventArgs e )
  //  {
